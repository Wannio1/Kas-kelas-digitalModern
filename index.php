...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div style="text-align: center; margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid rgba(74, 222, 128, 0.15);">
                <p style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 0.5rem;">Belum punya akun?</p>
                <a href="register.php" style="color: var(--primary); text-decoration: none; font-weight: 600; font-size: 0.95rem; transition: all 0.2s ease;">
                    Daftar Akun Baru
                </a>
            </div>
        </div>
